...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return BoardTasks; });
...
class BoardTasks extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class Sort extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return `<div class="board__filter-list">
          <a href="#" class="board__filter" data-sort='${_util__WEBPACK_IMPORTED_MODULE_1__["sortTypes"].DEFAULT}'>SORT BY DEFAULT</a>
          <a href="#" class="board__filter" data-sort='${_util__WEBPACK_IMPORTED_MODULE_1__["sortTypes"].DATE_UP}'>SORT BY DATE up</a>
          <a href="#" class="board__filter" data-sort='${_util__WEBPACK_IMPORTED_MODULE_1__["sortTypes"].DATE_DOWN}'>SORT BY DATE down</a>
        </div>`;
  }
}
...
class TaskEdit extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
              ...
              <div class="card__inner">
                ...
                <div class="card__settings">
                  ...
                  <div class="card__colors-inner">
                    ...
                    ${_util__WEBPACK_IMPORTED_MODULE_1__["availableTasksColors"].map((color) => `
                    <input
                        type="radio"
                        id="color-${color}-4"
  ...
  _setColorPickerHandler() {
    this.getElement().querySelector(`.card__colors-wrap`).addEventListener(`click`, (evt) => {
      if (Object(_util__WEBPACK_IMPORTED_MODULE_1__["isInputTag"])(evt.target.tagName)) {
        evt.preventDefault();
        _util__WEBPACK_IMPORTED_MODULE_1__["availableTasksColors"].forEach((color) => this._element.classList.remove(`card--${color}`));
  ...
  _setHashTagsHandler() {
    this.getElement().querySelector(`input[name='hashtag-input']`).addEventListener(`keydown`, (evt) => {
      if (Object(_util__WEBPACK_IMPORTED_MODULE_1__["isEnterKeydown"])(evt.code)) {
        evt.preventDefault();
  ...
  _renderHashtag(tagValue) {
    Object(_util__WEBPACK_IMPORTED_MODULE_1__["renderElementIn"])(this._element.querySelector(`.card__hashtag-list`), Object(_util__WEBPACK_IMPORTED_MODULE_1__["createElement"])(this._getHashtagTemplate(tagValue)), _util__WEBPACK_IMPORTED_MODULE_1__["Position"].BEFOREEND);
  }
...
/* harmony import */ var _components_board_tasks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/board-tasks */ "./src/components/board-tasks.js");
/* harmony import */ var _components_no_tasks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/no-tasks */ "./src/components/no-tasks.js");
/* harmony import */ var _components_sort__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/sort */ "./src/components/sort.js");
...
/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./task */ "./src/controllers/task.js");
...
class BoardController {
  constructor(container, tasksData) {
    ...
    this._boardContainer = new _components_board__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._boardTasksContainer = new _components_board_tasks__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._loadMoreButton = new _components_load_more_button__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._sort = new _components_sort__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._renderedTasks = [];
  ...
  init() {
    const onLoadButtonClick = (evt) => {
      this._renderTasks(this._tasksData.splice(0, _util__WEBPACK_IMPORTED_MODULE_0__["TASKS_COUNT_PER_LOAD"]));
    ...
    if (this._tasksData.length === 0) {
      Object(_util__WEBPACK_IMPORTED_MODULE_0__["renderElementIn"])(this._boardContainer.getElement(), new _components_no_tasks__WEBPACK_IMPORTED_MODULE_3__["default"]().getElement());
    } else {
      this._sort.getElement().addEventListener(`click`, (evt) => {
        ...
        switch (true) {
          case evt.target.dataset.sort === _util__WEBPACK_IMPORTED_MODULE_0__["sortTypes"].DEFAULT: {
            this._renderedTasks.forEach((taskData) => this._renderTask(taskData));

            break;
          }
          case evt.target.dataset.sort === _util__WEBPACK_IMPORTED_MODULE_0__["sortTypes"].DATE_UP: {
            this._renderedTasks.slice().sort((a, b) => a.dueDate - b.dueDate).forEach((taskData) => this._renderTask(taskData));

            break;
          }
          case evt.target.dataset.sort === _util__WEBPACK_IMPORTED_MODULE_0__["sortTypes"].DATE_DOWN: {
      ...
      Object(_util__WEBPACK_IMPORTED_MODULE_0__["renderElementIn"])(this._boardContainer.getElement(), this._sort.getElement());

      this._renderTasks(this._tasksData.splice(0, _util__WEBPACK_IMPORTED_MODULE_0__["TASKS_COUNT_PER_LOAD"]));

      Object(_util__WEBPACK_IMPORTED_MODULE_0__["renderElementIn"])(this._boardContainer.getElement(), this._boardTasksContainer.getElement());

      this._loadMoreButton.getElement().addEventListener(`click`, onLoadButtonClick);
      Object(_util__WEBPACK_IMPORTED_MODULE_0__["renderElementIn"])(this._boardContainer.getElement(), this._loadMoreButton.getElement());
    }

    Object(_util__WEBPACK_IMPORTED_MODULE_0__["renderElementIn"])(this._container, this._boardContainer.getElement());
  }
  ...
  _renderTask(taskData) {
    const taskController = new _task__WEBPACK_IMPORTED_MODULE_6__["default"](this._boardTasksContainer, taskData, this._onDataChange, this._onChangeView);
    taskController.init();
...
/* harmony import */ var flatpickr_dist_themes_light_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! flatpickr/dist/themes/light.css */ "./node_modules/flatpickr/dist/themes/light.css");
/* harmony import */ var flatpickr_dist_themes_light_css__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(flatpickr_dist_themes_light_css__WEBPACK_IMPORTED_MODULE_5__);
...
class TaskController {
  constructor(container, taskData, onDataChange, onChangeView) {
    ...
    this._taskView = new _components_task__WEBPACK_IMPORTED_MODULE_0__["default"](this._taskData);
    this._taskEdit = new _components_task_edit__WEBPACK_IMPORTED_MODULE_1__["default"](this._taskData);
  ...
  init() {
    flatpickr__WEBPACK_IMPORTED_MODULE_3___default()(this._taskEdit.getElement().querySelector(`input[name="date"]`), {
      altInput: true,
      dateFormat: `U`,
      altFormat: `d F, h:i K`,
    ...
    Object(_util__WEBPACK_IMPORTED_MODULE_2__["renderElementIn"])(this._container.getElement(), this._taskView.getElement());
  }
...
const generateFilterData = (tasks) => [
  {
    title: `All`,
    count: tasks.length,
  },
...
/*!*******************************!*\
  !*** ./src/data/task-data.js ***!
  \*******************************/
/*! exports provided: generateTaskData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateTaskData", function() { return generateTaskData; });
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util */ "./src/util.js");
...
const generateTaskData = () => ({
  ...
  dueDate: Date.now() + (1 + Object(_util__WEBPACK_IMPORTED_MODULE_0__["getRandomInt"])(6)) * 24 * 3600 * 1000,
  repeatingDays: {
    'mo': false,
    'tu': false,
  ...
  tags: new Set([
    ...
    `business`,
    `weekend`
  ].sort(() => 0.5 - Math.random()).slice(0, Object(_util__WEBPACK_IMPORTED_MODULE_0__["getRandomInt"])(3))),
  color: _util__WEBPACK_IMPORTED_MODULE_0__["availableTasksColors"][Math.floor(Math.random() * _util__WEBPACK_IMPORTED_MODULE_0__["availableTasksColors"].length)],
...
/* harmony import */ var _data_task_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./data/task-data */ "./src/data/task-data.js");
/* harmony import */ var _data_filter_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./data/filter-data */ "./src/data/filter-data.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./util */ "./src/util.js");
/* harmony import */ var _controllers_board__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./controllers/board */ "./src/controllers/board.js");
...
const TASKS_COUNT = Object(_util__WEBPACK_IMPORTED_MODULE_5__["getRandomInt"])(20, _util__WEBPACK_IMPORTED_MODULE_5__["TASKS_COUNT_PER_LOAD"]);

const mainBlock = document.querySelector(`.main`);
const mainControlBlock = mainBlock.querySelector(`.main__control`);

const tasks = new Array(TASKS_COUNT).fill(``).map(_data_task_data__WEBPACK_IMPORTED_MODULE_3__["generateTaskData"]);

Object(_util__WEBPACK_IMPORTED_MODULE_5__["renderElementIn"])(mainControlBlock, new _components_menu__WEBPACK_IMPORTED_MODULE_0__["default"]().getElement());
Object(_util__WEBPACK_IMPORTED_MODULE_5__["renderElementIn"])(mainBlock, new _components_search__WEBPACK_IMPORTED_MODULE_1__["default"]().getElement());
Object(_util__WEBPACK_IMPORTED_MODULE_5__["renderElementIn"])(mainBlock, new _components_filter__WEBPACK_IMPORTED_MODULE_2__["default"](Object(_data_filter_data__WEBPACK_IMPORTED_MODULE_4__["generateFilterData"])(tasks)).getElement());

new _controllers_board__WEBPACK_IMPORTED_MODULE_6__["default"](mainBlock, tasks).init();
...
/*!*********************!*\
  !*** ./src/util.js ***!
  \*********************/
/*! exports provided: getRandomInt, createElement, Position, renderElementIn, TASKS_COUNT_PER_LOAD, sortTypes, availableTasksColors, isEnterKeydown, isInputTag */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderElementIn", function() { return renderElementIn; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TASKS_COUNT_PER_LOAD", function() { return TASKS_COUNT_PER_LOAD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortTypes", function() { return sortTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "availableTasksColors", function() { return availableTasksColors; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isEnterKeydown", function() { return isEnterKeydown; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isInputTag", function() { return isInputTag; });
...
const renderElementIn = (component, element, position = Position.BEFOREEND) => {
  switch (position) {
...
const availableTasksColors = [`black`, `yellow`, `blue`, `green`, `pink`];
const key = {
  ENTER: `enter`
};

const isEnterKeydown = (code) => code.toLowerCase() === key.ENTER;

const isInputTag = (tagName) => tagName.toLowerCase() === `input`;
